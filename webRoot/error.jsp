				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
					 <li><a href="home.jsp" class="scroll">Home</a></li>
						...
						<li><a href="recommend.jsp" class="scroll">Recommend</a></li>
						<li><a href="AboutUs.jsp" class="scroll">ContactUs</a></li>
...
<div class="gallery" id="gallery">
        ...
        <!--=============== section team ===============-->
			...
			<div class="portfolio">
					...
					<div class="portfolio logos mix_all wow bounceIn" data-wow-delay="0.4s" data-cat="logos" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
								<a href="findOneCourse?id=3" >  <img src="images/cs545.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		                </div>
					</div>
					<div class="portfolio logos mix_all wow bounceIn" data-wow-delay="0.4s" data-cat="logos" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
